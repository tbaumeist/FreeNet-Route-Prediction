...
public class PathComparer {
    ...
    public String compareStorageNodes(Topology topology, int hopReset,
            int maxHTL, List<PathSet[]> pathSets, ActualRoutePath actPath) {

        StringBuilder b = new StringBuilder();

        PathSet ps = PathSet.findPathSet(actPath.getOriginNode(),
                actPath.getHTL(), pathSets);
