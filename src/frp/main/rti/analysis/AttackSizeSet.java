...
public class AttackSizeSet {
    ...
    public AttackSizeSet(int subSetSize, List<AttackPair> attackPair,
        ...
        System.out
                .println("Analysing RTI set size " + this.subSetSize + " ...");
    ...
    private void calculateTop(Progresser prog, List<AttackPair> attackPair,
            int count) {
        ...
        calculateTop(prog,
                minusTargets(this.curMaxAttackNodes, top, attackPair), count);
    }

    private void calculateBottom(Progresser prog, List<AttackPair> attackPair,
            int count) {
        if (count > this.subSetSize)
            return;
