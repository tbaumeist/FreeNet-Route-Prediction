...
public class RoutingManager {
    ...
    private void convertToIntersections(
            Hashtable<AttackPair, AttackPair> pairs,
            InsertNodeIntersections currentInter, PrintStream interWriter) {

        saveIntersections(pairs, interWriter, currentInter);
    }

    private void saveIntersections(Hashtable<AttackPair, AttackPair> pairs,
            PrintStream interWriter, InsertNodeIntersections currentInter) {
