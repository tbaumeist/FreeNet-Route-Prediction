...
public class GephiHelper { 
	...
	public DirectedGraph loadGraphFile(InputStream topologyFile, String fileExt) throws Exception{
        ...
        if(importBuilder == null)
        	throw new Exception("Unable to find file importer for the given file type : " + fileExt);
        
        //Import file       
        Container container = importController.importFile(topologyFile, importBuilder.buildImporter());
    ...
    private FileImporterBuilder getMatchingImporter(String extension) {
    	if(!extension.startsWith("."))
    		extension = "." + extension;
    	FileImporterBuilder[]fileImporterBuilders = Lookup.getDefault().lookupAll(FileImporterBuilder.class).toArray(new FileImporterBuilder[0]);
